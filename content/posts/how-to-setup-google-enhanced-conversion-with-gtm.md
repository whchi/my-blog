...
這裡使用第 3 種方式，具體實作如下
1. 在需要轉換的頁面埋設 hash(sha256) 過的第一方資料放到 js global 變數裡面
...
window.eeData = {
    ...
    address: {
        ...
        // firstName: sha256FirstName,
        lastName: 'last name',
        // lastName: sha256LastName,
        street: '大同街',
        city: '台北市',
        region: '中山區',
        postCode: 104,
...
完整設定如下，如果傳送 hash 過的資料，則要帶`sha_256_*`
```js
function(){
	return {
		"email": eeData.email,
        // "sha256_email_address": eeData.email
		"phone_number": eeData.phone,
        // "sha256_phone_number": eeData.phone
        "address": {
            "first_name": eeData.address.firstName,
            // "address.sha256_first_name": eeData.firstName
            "last_name": eeData.address.lastName,
            // "address.sha256_last_name": eeData.lastName
