...
image: '/images/preview/drone.jpeg'
---
...
1. 建立 OAuth app
    {{< figure
        src="/images/github-oauth-app.png"
        title="create github oauth app"
        caption="oauth app landing page">}}
    {{< figure
        src="/images/github-oauth-app-setting.png"
        title="settings"
...
2. 建立 repo 與設定 webhook
    {{< figure
        src="/images/github-repo-webhook.png"
        title="settings"
        caption="設定基本資料，ngrok 是好東西">}}
...
1. 登入 drone-server
    {{< figure
        src="/images/drone-landing-page.png"
        title=""
        caption="於瀏覽器輸入 domain">}}
2. enable repo for drone
    {{< figure
        src="/images/drone-enable-repo.png"
        title=""
        caption="">}}
3. 修改 repo 以觸發 build
    {{< figure
        src="/images/drone-build.png"
        title=""
