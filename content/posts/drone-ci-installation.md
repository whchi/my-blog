...
tags: ['drone', 'DevOps']
summary: '（偽）無人機體驗心得'
preview_figure: 'https://assets.d6i.dev/blog/preview/drone.webp'
preview_figcaption: 'Drone 這個名字老是找到無人機'
preview_image: 'https://assets.d6i.dev/blog/preview/drone.webp'
---
...
# overview
{{< figure
    src="https://assets.d6i.dev/blog/drone-overview.webp"
    title="overview"
    caption="overview">}}
...
1. 建立 OAuth app
    {{< figure
        src="https://assets.d6i.dev/blog/github-oauth-app.webp"
        title="create github oauth app"
        caption="oauth app landing page">}}
    {{< figure
        src="https://assets.d6i.dev/blog/github-oauth-app-setting.webp"
        title="settings"
...
2. 建立 repo 與設定 webhook
    {{< figure
        src="https://assets.d6i.dev/blog/github-repo-webhook.webp"
        title="settings"
        caption="設定基本資料，ngrok 是好東西">}}
...
1. 登入 drone-server
    {{< figure
        src="https://assets.d6i.dev/blog/drone-landing-page.webp"
        title=""
        caption="於瀏覽器輸入 domain">}}
2. enable repo for drone
    {{< figure
        src="https://assets.d6i.dev/blog/drone-enable-repo.webp"
        title=""
        caption="">}}
3. 修改 repo 以觸發 build
    {{< figure
        src="https://assets.d6i.dev/blog/drone-build.webp"
        title=""
        caption="修改後觸發的 build log">}}
    {{< figure
        src="https://assets.d6i.dev/blog/drone-dashboard.webp"
        title=""
        caption="dashboard">}}
