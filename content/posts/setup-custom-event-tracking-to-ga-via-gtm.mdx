...
<Figure src="https://assets.d6i.dev/blog/setup-gtm-trigger-type.webp" caption="以 link 為主，且 path 為 tags/.+" />

<Figure src="https://assets.d6i.dev/blog/setup-gtm-trigger-type-1.webp" caption="以 element 為主，id 等於 switch_theme" />

此外還有 page view、user engagement 以及其他還無法歸納的類型可以使用，可依照自己的需求決定要埋設的類型 trigger
# 設置 tag 並綁定 trigger
<Figure src="https://assets.d6i.dev/blog/setup-gtm-tag.webp" caption="新增 tag 綁定 trigger" />
...
<Figure src="https://assets.d6i.dev/blog/setup-gtm-event-result-review.webp" caption="額外設定的 switch_theme 事件呈現在 console 上" />
## 補充
