...
## 2. 建立 data stream
照表填寫
<Figure src="https://assets.d6i.dev/blog/ga-data-stream.webp" caption="data stream 設定" />

## 3. copy measurement id
<Figure src="https://assets.d6i.dev/blog/ga-copy-measurement-id.webp" caption="copy measurement id" />
...
## 2. 建立 tag
<Figure src="https://assets.d6i.dev/blog/gtm-setup-ga4-tag.webp" caption="選擇 GA4 configuration，貼上剛剛複製的 measurement id" />
## 3. 貼代碼到你的 site
<Figure src="https://assets.d6i.dev/blog/gtm-code.webp" caption="代碼示意圖" />
## 4. 驗證結果
<Figure src="https://assets.d6i.dev/blog/gtm-preview-tag-1.webp" caption="點選 preview 前往驗證" />
<Figure src="https://assets.d6i.dev/blog/gtm-preview-tag-2.webp" caption="設定網站位置進行驗證" />
<Figure src="https://assets.d6i.dev/blog/gtm-preview-tag-site.webp" caption="驗證結果-site（需裝套件）" />
<Figure src="https://assets.d6i.dev/blog/gtm-preview-tag-dashboard.webp" caption="驗證結果-dashboard" />
