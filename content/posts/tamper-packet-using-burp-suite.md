...
summary: '改封包 94 這麼簡單'
preview_figure: '/images/preview/what-are-you-looking-at.jpg'
preview_figcaption: "I'm watching you"
preview_image: '/images/preview/what-are-you-looking-at.jpg'
---
...
1. 關閉 proxy 攔截
{{< figure
    src="/images/burp-suite-setup-1.png"
    title="close proxy intercept"
    caption="確認攔截器已關閉">}}
2. 確認 proxy port 並設定為 loopback
{{< figure
    src="/images/burp-suite-setup-2.png"
    title="setup proxy"
    caption="確認 proxy 設定正確">}}
3. 設定 browser proxy
{{< figure
    src="/images/burp-suite-setup-3.png"
    title="setup browser proxy"
    caption="在瀏覽器的設定直接改">}}
4. 進行攔截
{{< figure
    src="/images/burp-suite-setup-4.png"
    title="start intercept"
    caption="">}}
# other env
1. 透過 burp suite 開啟瀏覽器輸入要攔截的網址
{{< figure
    src="/images/burp-suite-setup-5.png"
    title=""
    caption="點擊 open browser">}}
2. 進行攔截
{{< figure
    src="/images/burp-suite-setup-6.png"
    title="系統架構"
...
{{< figure
    src="/images/burp-suite-tamper-1.png"
    title="tamper response"
    caption="跑到要竄改的 request 時針對回應進行竄改">}}

{{< figure
    src="/images/burp-suite-tamper-2.png"
    title="tamper response"
